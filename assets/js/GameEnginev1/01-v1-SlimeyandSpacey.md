...
permalink: /gamify/SlimeyandSpacey
---
...
<script type="module">
    ...
    import GameLevelSlimeyandspacey from "{{site.baseurl}}/assets/js/GameEnginev1/GameLevelSlimeyandspacey.js";
    import { pythonURI, javaURI, fetchOptions } from '{{site.baseurl}}/assets/js/api/config.js';

    const gameLevelClasses = [GameLevelSlimeyandspacey];
